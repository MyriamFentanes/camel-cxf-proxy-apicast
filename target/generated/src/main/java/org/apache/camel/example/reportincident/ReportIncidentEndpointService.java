 ...
 * 2017-09-22T13:48:11.844-04:00
 * Generated source version: 3.1.5.redhat-630133
 * 
 */
@WebServiceClient(name = "ReportIncidentEndpointService", 
                  wsdlLocation = "file:/home/mfentanes/camel-cxf-proxy-apicast/src/main/resources/etc/report_incident.wsdl",
...
public class ReportIncidentEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/mfentanes/camel-cxf-proxy-apicast/src/main/resources/etc/report_incident.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/mfentanes/camel-cxf-proxy-apicast/src/main/resources/etc/report_incident.wsdl");
        }
        WSDL_LOCATION = url;
    }
